...
export interface ICaduceusContractsRegistry {
    ...
    OhmDaiBondDepository: ContractVersions<OlympusBondDepository>;
...
export const contracts = new NetworksContractsRegistry<ICaduceusContractsRegistry>();

const mainOperaContract: ICaduceusContractsRegistry = {
    ...
    OhmDaiBondDepository: new ContractVersions<OlympusBondDepository>([
        version(
            OlympusBondDepository__factory.connect,
        ),
    ]),
...
const testNetOperaContract: ICaduceusContractsRegistry = {
    OlympusERC20Token: new ContractVersions([
        version(
            OlympusERC20Token__factory.connect,
...
const hardhatContracts: ICaduceusContractsRegistry = {
    OlympusERC20Token: new ContractVersions([
...
contracts.addNetwork(Network.FUJI_AVALANCHE, hardhatContracts);
contracts.addNetwork(Network.RINKEBY, hardhatContracts);
contracts.addNetwork(Network.BSC_TESTNET, hardhatContracts);
