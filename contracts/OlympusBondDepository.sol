...
contract OlympusBondDepository is Ownable {
    ...
    function deposit(
        ...
        uint nativePrice = _bondPrice(); // BCV*debRatio()+10^2

        require( _maxPrice >= nativePrice, "Slippage limit: more than max price" ); // slippage protection

        uint value = ITreasury( treasury ).valueOf( principle, _amount ); // returns OHM valuation of asset 
        uint payout = payoutFor( value ); // payout in OHM to bonder is computed ie: value/bondPrice()
