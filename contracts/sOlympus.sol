...
contract sOlympus is ERC20Permit, Ownable {
  ...
  // Total Fragments = Total sOHM = Total supply = 500
  // Let MAX_UINT256 = 10,011
  // Total GONS = 10,011 - (10,011 % 500) = 10,000
  // gons/fragment = Total Gons / total sOHM = 10,000 / 500 = 20
  ...
  constructor() ERC20("Staked Caduceus", "sCDS", 9) ERC20Permit() {
    ...
    returns (uint256)
  {
    ...
    uint256 circulatingSupply_ = circulatingSupply(); // Circulating Supply = Total sOHM - Balance of Staking Contract
    ...
    if (profit_ == 0) {
      ...
      rebaseAmount = profit_.mul(_totalSupply).div(circulatingSupply_); // rebase Amount = (profit x Total OHM) / Circulating Supply
    } else {
